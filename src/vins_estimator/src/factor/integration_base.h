...
class IntegrationBase
{
  public:
    ...
    void push_back(double t, double dt, const Eigen::Vector3d &acc, const Eigen::Vector3d &gyr)
    {
        dt_buf.push_back(dt);
        t_buf.push_back(t);
                            ...
                            Eigen::Vector3d &result_linearized_ba, Eigen::Vector3d &result_linearized_bg, bool update_jacobian)
    {
        ...
        if(update_jacobian)
        {
            ...
            jacobian_buf.push_back(jacobian);
            cov_buf.push_back(covariance);
        }
    ...
    std::vector<double> dt_buf, t_buf;
